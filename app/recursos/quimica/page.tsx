...
import { FlaskConical, Users, MapPin, Shield, Monitor } from "lucide-react"
...
export default function QuimicaPage() {
  ...
  const labs = getResourcesByType("lab-quimica")
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Laboratório de Química</h1>
            <p className="text-gray-600 mt-2">Espaços equipados para experimentos químicos</p>
          </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>{lab.specifications?.["Segurança"]}</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
